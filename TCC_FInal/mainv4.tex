...
% Comando para ativar espaçamento 1.5 (normas ABNT)
\newcommand{\iniciotesesabnt}{%
    \setstretch{1.5}%
    \setlength{\parskip}{0pt}%
}

% Comando para seções que iniciam em nova página
\newcommand{\sectionabnt}{\clearpage\section}
\newcommand{\subsectionabnt}{\subsection}

% Configuração de formatação de seções numeradas
\titleformat{\section}
{\normalfont\fontsize{12}{14}\bfseries\raggedright}{\thesection}{1em}{}[\titlerule]
\titlespacing*{\section}{0pt}{\baselineskip}{\baselineskip}

% Configuração para seções NÃO NUMERADAS (AGRADECIMENTOS, RESUMO, etc.)
\titleformat{name=\section,numberless}
{\normalfont\fontsize{12}{14}\bfseries\raggedright}{}{0em}{}[\titlerule]
...
\floatstyle{plain}
\newfloat{figura}{H}{lop}[section]
\floatname{figura}{Figura}

% ESTILO SIMPLES - SEM CABEÇALHO
\pagestyle{plain}
...
\newcommand{\capa}{
    \begin{titlepage}
        ...
        % Logo do IFPB
        \includegraphics[width=0.3\textwidth]{ifpb.png}

        \vspace{0.5cm}
        {\large Instituto Federal de Educação, Ciência e Tecnologia da Paraíba - IFPB}\\
        \vspace{0.2cm}
        {\large Unidade Acadêmica de Informática - UAI}\\
        \vspace{0.2cm}
        {\large Bacharelado em Engenharia de Computação}\\

        \vspace{3cm}
        {\Large Anderson Lucas Cordeiro Braz}\\
        \vspace{2cm}
        {\Large Análise De Dados Climáticos Da Paraíba Para Identificação De Padrões E Mudanças Climáticas}\\
        \vspace{3cm}
        {\large Campina Grande - PB}\\
        \vspace{1cm}
        {\large 2025}
    \end{titlepage}
}
...
% ==================== CAPA E IDENTIFICAÇÃO (espaçamento 1.0) ====================
\capa
...
% Título
{\centering\textbf{\large Análise de dados climáticos da Paraíba para identificação de padrões e mudanças climáticas}\par}
...
% Rodapé
{\centering
\textbf{Orientador: Paulo Ribeiro Lins Júnior}\\[2cm]
...
% ==================== A PARTIR DAQUI ESPAÇAMENTO 1.5 (normas ABNT) ====================
\iniciotesesabnt

% ==================== AGRADECIMENTOS ====================
\sectionabnt*{AGRADECIMENTOS}
...
\sectionabnt*{LISTA DE FIGURAS E TABELAS}
\begingroup
\let\clearpage\relax
\listoftables
\listoffigures
...
\begin{enumerate}[label=\Roman*., left=1.25cm]
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth, keepaspectratio]{figura_5_1.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{figura_5_4_parte1.png}
\\
\includegraphics[width=0.95\textwidth]{figura_5_4_parte2.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth, keepaspectratio]{figura_5_5_parte1.png}
\\
\includegraphics[width=0.95\textwidth, keepaspectratio]{figura_5_5_parte2.png}
\caption{Chuva mensal por região (por faixa de anos)}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth, keepaspectratio]{figura_5_7.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth, keepaspectratio]{figura_5_8_pt1.png}
\includegraphics[width=0.95\textwidth, keepaspectratio]{figura_5_8_pt2.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth, keepaspectratio]{figura_5_12.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth, keepaspectratio]{figura_5_13.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth, keepaspectratio]{figura_5_15.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth, keepaspectratio]{figura_5_16.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth, keepaspectratio]{figura_5_17.png}
