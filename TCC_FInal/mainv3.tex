...
\usepackage{etoolbox}
\usepackage{tocloft}
\usepackage{needspace} % Adicione esta linha com os outros pacotes
...
% --- FIGURA 5_16 CORRIGIDA ---
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.85\textwidth]{figura_5_16.png}  % REDUZIDO para 0.85
\caption{Tendências das variáveis médias por cidade}
\label{fig:mean_cidades}
\end{figure}

\vspace{15pt}  % Espaço após figura

% Pequeno espaço após a figura
\vspace{\baselineskip}
...
% --- FIGURA 5_17 CORRIGIDA ---
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.85\textwidth]{figura_5_17.png}  % REDUZIDO para 0.85
